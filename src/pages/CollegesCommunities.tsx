            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {orgTypes.map((item, index) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden p-10 rounded-[2.5rem] bg-white border border-zinc-100 hover:border-blue-600/30 transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(37,99,235,0.1)]"
                >
                  {/* Background ID */}
